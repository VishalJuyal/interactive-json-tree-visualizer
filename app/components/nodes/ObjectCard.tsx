...
export default function ObjectCard({ data }: NodeProps) {
  ...
  return (
    <div
      className={`relative px-3 sm:px-4 py-2 sm:py-3 bg-[#6C63FF] text-white rounded-lg shadow-md font-semibold transition-all cursor-pointer text-xs sm:text-sm ${
